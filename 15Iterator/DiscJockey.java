...
public class DiscJockey {
  ...
  /*
   * public void showTheSongs() { ArrayList aL70sSongs = songs70s.getBestSongs();
   * System.out.println("Songs of the 70s\n"); for (int i = 0; i <
   * aL70sSongs.size(); i++) { SongInfo bestSongs = (SongInfo) aL70sSongs.get(i);
   ...
   * array80sSongs.length; i++) { SongInfo bestSongs = array80sSongs[i];
   * System.out.println(bestSongs.getSongName());
   * System.out.println(bestSongs.getBandName());
   * System.out.println(bestSongs.getYearReleased()); }
   * 
   * Hashtable<Integer, SongInfo> ht90sSongs = songs90s.getBestSongs();
   * System.out.println("Songs of the 90s\n"); for (Enumeration<Integer> e =
   * ht90sSongs.keys(); e.hasMoreElements();){ SongInfo bestSongs =
   * ht90sSongs.get(e.nextElement()); System.out.println(bestSongs.getSongName());
   * System.out.println(bestSongs.getBandName());
   * System.out.println(bestSongs.getYearReleased()); } }
   */
